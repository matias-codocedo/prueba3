# prueba 3 matias codocedo y claudio rivera
import pyotp    #prueba 3 generador de password 
import sqlite3  #aqui pondremos users y passwords
import hashlib  
import uuid     #aqui crearemos los ID universales
from flask import Flask, request
app = Flask(__name__)
db_name = 'test.db'
@app.route('/')
def index():
    return 'PRUEBA 3 MATIAS CODOCEDO, CLAUDIO RIVERA'
